"""Quanti-x quantitative KPI engine."""
...
class KPIEngine:
    ...
    def compute_kpis(
        ...
        # 6. Baseline versus Quanti-x comparison table
        comparison = {
            "block_utilization_pct": {
                "manual_siloed": 46.5,
                "quanti_x": round(min(96.0, 52.0 + efficiency_gain_pct * 0.9), 1),
