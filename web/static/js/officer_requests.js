...
async function loadOfficerRequests(){
 ...
 if(!d.requests?.length){box.innerHTML='<div class="p-4 rounded-lg bg-slate-950 border border-slate-800 text-xs text-slate-500">No requests in this filter. Open Engineer Portal to submit a request.</div>';return;}
